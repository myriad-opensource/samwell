# -*- coding: utf-8 -*-
#
# samwell documentation build configuration file
#
...
project = u'samwell'
copyright = u'2021, Myriad Genetics, Inc.'

# Included at the end of each rst file
rst_epilog = '''
.. _samwell: https://github.com/fulcrumgenomics/samwell
...
latex_documents = [
    ('index', 'samwell.tex', u'samwell documentation', u'Nils Homer, Tim Fennell, et al.', 'manual'),
]
